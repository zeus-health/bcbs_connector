...
select
    ...
    to_date(cast(parse_json(data):date_of_service_to as string), 'YYYYMMDD') as svcdt,
    to_date(cast(parse_json(data):inpatient_admit_date as string), 'YYYYMMDD') as admitdt,
    to_date(cast(parse_json(data):inpatient_discharge_date as string), 'YYYYMMDD') as dischdt,
    ...
    to_date(cast(parse_json(data):paid_date as string), 'YYYYMMDD') as pddate,
